<?php
/**
 * The pipeline module simplified chinese file of ZenTaoPHP.
 *
...
$lang->pipeline->restorepage  = '恢复页面';
$lang->pipeline->name  = '流水线名';
$lang->pipeline->steps  = '步骤';
$lang->pipeline->id      = '编号';
$lang->pipeline->title   = '标题';
$lang->pipeline->date    = '日期';
