   ...
   /**
    ...
    public function batchCreateRootTask()
    {
        ...
        foreach ($pipeline->steps as $step) {
            //error_log("oscar: batchCreateRootTask step:$step->id $step->type dept:$step->dept");
            if($step->type == 'group')
            {
                ...
                //error_log("======batchCreateTask: $task->name  $task->deadline $task->dept");
                //error_log("task:" . var_dump($task));
                ...
                //error_log("pipelie task:".  $this->dao->lastInsertID());
                //error_log(dao::getError());

                //baseDAO::$debug_log_sql = false;
