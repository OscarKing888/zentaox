...
<div id='imageFile'><?php echo html::image($this->createLink('file', 'readthumb', "fileID=$file->id"));?></div>
<?php else:?>
<div id='txtFile'>
  <div>
  <?php
...
function setCharset(charset)
{
    ...
    var link  = createLink('file', 'downloadthumb', 'fileID=' + fileID + '&mouse=left') + param;
    location.href = link;
}
</script>
