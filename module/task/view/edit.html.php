                ...
                <div class='form-group'>
                    <div class='input-group'>
                        <input type='hidden' id='color' name='color' data-provide='colorpicker'
                               ...
                               data-btn-tip='<?php echo $lang->task->colorTag ?>' value='<?php echo $task->color ?>'
                               data-update-text='.task-title, #name'>
                ...
                <fieldset>
                    ...
                    <table class='table table-form'>
                        ...
                        <tr>
                            ...
                            <td><?php echo html::select('milestone', $milestones, $task->milestone, 'class="form-control chosen"'); ?></td>
                        </tr>
                        ...
                        <?php if ($config->global->flow != 'onlyTask' and $project->type != 'ops'): ?>
                            <tr>
                                ...
                                <td>
                                    <span id="storyIdBox"><?php echo html::select('story', $stories, $task->story, "class='form-control chosen'"); ?></span>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <tr>
                ...
                <fieldset>
                    ...
                    <table class='table table-form'>
                        ...
                        <tr>
                            ...
                            <td><?php echo $task->consumed . ' ';
                                common::printIcon('task', 'recordEstimate', "taskID=$task->id", $task, 'list', '', '', 'iframe', true); ?></td>
                        </tr>
                        <tr>
