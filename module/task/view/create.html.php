    ...
    <form class='form-condensed' method='post' enctype='multipart/form-data' id='dataform' data-type='ajax'>
        <table class='table table-form'>
            ...
            <tr>
                ...
                <!-- 1.20紧急bug 建任务直接指定人，不指定部门 -->
                <th><?php echo $lang->task->assignedTo; ?></th>
                <td><?php echo html::select('assignedTo', $members, $task->assignedTo, 'class=form-control onchange="setOwners(this.value)"'); ?></td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group" id="dataPlanGroup">
                            ...
                            <label class='input-group-addon affair'><input type='checkBox' name='multiple' id="multipleBox" value='1' /><?php echo $lang->task->multipleAB; ?>
                            </label>
                        </div>
                    </td>
                    <td>
