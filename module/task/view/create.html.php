...
<div class='container mw-1400px'>
    <div id='titlebar'>
        <div class='heading'>
            ...
            <strong>
                <small class='text-muted'><?php echo html::icon($lang->icons['create']); ?></small> <?php echo $lang->task->create; ?>
            </strong>
        </div>
        <div class='actions'>
            <button type="button" class="btn btn-default" data-toggle="customModal"><i class='icon icon-cog'></i>
            </button>
        </div>
    </div>
    <form class='form-condensed' method='post' enctype='multipart/form-data' id='dataform' data-type='ajax'>
        <table class='table table-form'>
            <tr>
                ...
                <td id='moduleIdBox'
                    class='w-p25-f'><?php echo html::select('module', $moduleOptionMenu, $task->module, "class='form-control chosen' onchange='setStories(this.value,$project->id)'"); ?></td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group" id="dataPlanGroup">
                            ...
                            <span class="input-group-addon team-group hidden"
                                  data-toggle='modalTeam'><?php echo $lang->task->team; ?></span>
                            <label class='input-group-addon affair'><input type='checkBox' name='multiple'
                                                                           id="multipleBox"
                                                                           value='1'/><?php echo $lang->task->multipleAB; ?>
                            </label>
                        </div>
                    </td>
                    <td>
                        <button type='button' class='btn btn-link<?php if ($task->type !== 'affair') echo ' hidden'; ?>'
                                id='selectAllUser'>
                    ...
                    <div class='row-table'>
                        <div class='col-table'>
                            <div class="input-group w-p100">
                                <input type='hidden' id='color' name='color' data-provide='colorpicker'
                                       data-wrapper='input-group-btn fix-border-right' data-pull-menu-right='false'
                                       data-btn-tip='<?php echo $lang->task->colorTag ?>' data-update-text='#name'
                                       value='<?php echo $task->color; ?>'>
                                <?php echo html::input('name', $task->name, "class='form-control' autocomplete='off'"); ?>
                                <?php if ($this->config->global->flow != 'onlyTask'): ?>
                                    <span class='input-group-btn'><a href='javascript:copyStoryTitle();' id='copyButton'
                                                                     class='btn'><?php echo $lang->task->copyStoryTitle; ?></a></span>
                                ...
                                <div class='input-group'>
                                    ...
                                    <?php else: ?>
                                        <div class='input-group-btn dropdown-pris'>
                                            <button type='button' class='btn dropdown-toggle br-0'
            ...
            <div class='modal-dialog'>
                ...
                <div class='modal-content'>
                    <table class="table table-form">
                        <?php for ($i = 0; $i < 6; $i++): ?>
                            <tr>
                                ...
                                <td class='w-90px'>
                                    ...
                                    <a href='javascript:;' class='btn btn-move-down btn-sm'><i
                        ...
                        <tr>
                            <td colspan='3'
                                class='text-center'><?php echo html::a('javascript:void(0)', $lang->confirm, '', "class='btn btn-primary' data-dismiss='modal'") ?></td>
                        </tr>
                    </table>
                </div>
            </div>
