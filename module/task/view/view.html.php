    ...
    <div class='col-main'>
        <div class='main'>
                        ...
                        <?php foreach ($task->children as $child): ?>
                            <tr class='text-center'>
                                ...
                                <td class='text-left'><a
                                            href="<?php echo $this->createLink('task', 'view', "taskID=$child->id"); ?>"><?php echo $child->name; ?></a>
                                </td>
            ...
            <fieldset id='commentBox' class='hide'>
                ...
                <form method='post'
                      action='<?php echo $this->createLink('action', 'comment', "objectType=task&objectID=$task->id") ?>'
                      target='hiddenwin'>
            ...
            <fieldset>
                ...
                <table class='table table-data table-condensed table-borderless'>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class='<?php echo 'pri' . zget($lang->task->priList, $task->pri); ?>'><?php echo $task->pri == '0' ? '' : zget($lang->task->priList, $task->pri) ?></span>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo $lang->task->mailto; ?></th>
                        <td><?php $mailto = explode(',', str_replace(' ', '', $task->mailto));
                            foreach ($mailto as $account) echo ' ' . zget($users, $account, $account); ?></td>
                    </tr>
                </table>
            </fieldset>
