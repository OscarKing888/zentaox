...
<form method='post'>
    <table class='table table-borderless mw-600px table-form' align='center'>
        <tr>
            <th align="right"><?php echo $lang->project->version; ?></th>
            <td>
...
<table class='table table-form table-fixed with-border mw-600px' align='center' id="buildList" role="grid">
    ...
    <tr class="colhead tablesorter-headerRow" role="row">
        ...
        <th class='w-100px'><?php echo $lang->project->version; ?></th>
        <th class='w-80px'><?php echo $lang->project->deadline; ?></th>
        ...
        <tr class="text-center">
            ...
            <td>
                ...
                if($v->active)
                {
                    ...
                    echo html::commonButton($lang->project->update, "id='update_version_deadline' onclick=\"on_updateVersionDeadline('$v->id')\"");
                }
                else
                {
            ...
            <td>
                ...
                if($v->active)
                {
                    ...
                    echo html::commonButton($lang->project->versionend, "id='close_version' onclick=\"on_closeVersion('$v->id')\"");
                }
                else
                {
                    echo $lang->project->close;
                    echo html::commonButton($lang->project->active, "id='active_version' onclick=\"on_activeVersion('$v->id')\"");
                }
                ?>
