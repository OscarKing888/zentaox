    ...
    <form method='post' enctype='multipart/form-data' target='hiddenwin' class='form-condensed'>
        <table class='table table-form'>
            ...
            <tr>
                ...
                <td><?php echo html::textarea('spec', htmlspecialchars($story->spec), 'rows=8 class="form-control"'); ?>
                    <span class='help-block'><?php echo $lang->story->specTemplate; ?></span></td>
            </tr>
            ...
            <?php if (strpos(",$showFields,", ',comment,') !== false): ?>
                <tr>
