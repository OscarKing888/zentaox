    ...
    <div id='titlebar'>
        <div class='heading'>
            <span class='prefix'><?php echo html::icon($lang->icons['story']); ?>
                <strong><?php echo $story->id; ?></strong></span>
                ...
                <div class='form-group'>
                    <div class='input-group'>
                        <input type='hidden' id='color' name='color' data-provide='colorpicker'
                               ...
                               data-btn-tip='<?php echo $lang->story->colorTag ?>' value='<?php echo $story->color ?>'
                               data-update-text='#title, .story-title'>
                ...
                <fieldset>
                    ...
                    <table class='table table-form'>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class='story-<?php echo $story->status; ?>'><?php echo $lang->story->statusList[$story->status]; ?></span>
                            </td>
                        </tr>
