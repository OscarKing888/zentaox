        ...
        <fieldset>
            ...
            <table class='table table-form'>
                ...
                <tr>
                    ...
                    <td colspan='2'><?php echo html::input('buildServerImagePath', $buildObj->buildServerImagePath, "class='form-control' autocomplete='off' placeholder='602245705509.dkr.ecr.us-west-2.amazonaws.com/firestrike-server:21041302'");?></td>
                </tr>
            </table>
        </fieldset>
        ...
        <fieldset>
            ...
            <table class='table table-form'>
                ...
                <tr>
                    ...
                    <td colspan='2'><?php echo html::input('buildApkPath', $buildObj->buildApkPath, "class='form-control' autocomplete='off' placeholder='\\\\172.20.1.188\\package\ReleaseQA\\Android'");?></td>
                </tr>
                <tr>
                    <th><?php echo $lang->buildex->buildApkPathReleasePath;?></th>
                    <td colspan='2'><?php echo html::input('buildApkPathReleasePath', $buildObj->buildApkPathReleasePath, "class='form-control' autocomplete='off' placeholder='\\\\172.20.1.188\\package\Release\\Android'");?></td>
                </tr>
            </table>
        </fieldset>
        ...
        <fieldset>
            ...
            <table class='table table-form'>
                ...
                <tr>
                    ...
                    <td><?php echo html::input('buildIosPath', $buildObj->buildIosPath, "class='form-control' autocomplete='off'  placeholder='\\\\172.20.1.188\\package\ReleaseQA\\iOS'");?></td>
                </tr>
            </table>
        </fieldset>
        ...
        <fieldset>
            ...
            <table class='table table-form'>
                ...
                <tr>
                    ...
                    <td><?php echo html::input('buildHotpatchAndroidPath', $buildObj->buildHotpatchAndroidPath, "class='form-control' autocomplete='off'  placeholder='\\\\172.20.1.188\\package\Patch\\Android'");?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo html::input('buildHotpatchiOSPath', $buildObj->buildHotpatchiOSPath, "class='form-control' autocomplete='off'  placeholder='\\\\172.20.1.188\\package\Patch\\iOS'");?></td>
                </tr>
            </table>
        </fieldset>
