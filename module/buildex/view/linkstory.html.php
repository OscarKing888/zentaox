...
<div id='unlinkStoryList'>
  <form method='post' id='unlinkedStoriesForm' target='hiddenwin' action='<?php echo $this->createLink('buildex', 'linkStory', "buildID={$build->id}&browseType=$browseType&param=$param");?>'>
