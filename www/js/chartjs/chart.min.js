...
(function (t) {
    "use strict";
    var i = t && t.zui ? t.zui : this, e = (i.Chart, function (t) {
    ...
    }, f = s.amd = "function" == typeof define && define.amd, p = s.isNumber = function (t) {
        return !isNaN(parseFloat(t)) && isFinite(t)
    }, g = s.max = function (t) {
        return Math.max.apply(Math, t)
    }, v = s.min = function (t) {
        return Math.min.apply(Math, t)
    }, x = (s.cap = function (t, i, e) {
        if (p(i)) {
            if (t > i) return i
        } else if (p(e) && e > t) return e;
        return t
    }, s.getDecimalPlaces = function (t) {
        return t % 1 !== 0 && p(t) ? t.toString().split(".")[1].length : 0
    }), m = s.radians = function (t) {
        return t * (Math.PI / 180)
    }, y = (s.getAngleFromPoint = function (t, i) {
        var e = i.x - t.x, s = i.y - t.y, n = Math.sqrt(e * e + s * s), o = 2 * Math.PI + Math.atan2(s, e);
        return 0 > e && 0 > s && (o += 2 * Math.PI), {angle: o, distance: n}
    }, s.aliasPixel = function (t) {
        return t % 2 === 0 ? 0 : .5
    }), w = (s.splineCurve = function (t, i, e, s) {
    ...
    }), S = (s.calculateScaleRange = function (t, i, e, s, n) {
        var o = 2, a = Math.floor(i / (1.5 * e)), h = o >= a, l = g(t), r = v(t);
        l === r && (l += .5, r >= .5 && !s ? r -= .5 : l += .5);
        for (var c = Math.abs(l - r), u = w(c), d = Math.ceil(l / (1 * Math.pow(10, u))) * Math.pow(10, u), f = s ? 0 : Math.floor(r / (1 * Math.pow(10, u))) * Math.pow(10, u), p = d - f, x = Math.pow(10, u), m = Math.round(p / x); (m > a || a > 2 * m) && !h;) if (m > a) x *= 2, m = Math.round(p / x), m % 1 !== 0 && (h = !0); else if (n && u >= 0) {
            if (x / 2 % 1 !== 0) break;
            x /= 2, m = Math.round(p / x)
        } else x /= 2, m = Math.round(p / x);
        return h && (m = o, x = p / m), {steps: m, stepValue: x, min: f, max: f + m * x}
    ...
    }), z = s.getMaximumWidth = function (t) {
        var i = t.parentNode;
        return i.clientWidth
    }, T = s.getMaximumHeight = function (t) {
        var i = t.parentNode;
        return i.clientHeight
    }, M = (s.getMaximumSize = s.getMaximumWidth, s.retinaScale = function (t) {
    ...
    e.instances = {}, e.Type = function (t, i, s) {
        ...
        initialize: function () {
            ...
            this.stop();
            var i = this.chart.canvas, e = z(this.chart.canvas),
                s = this.options.maintainAspectRatio ? e / this.chart.aspectRatio : T(this.chart.canvas);
            return i.width = this.chart.width = e, i.height = this.chart.height = s, M(this.chart), "function" == typeof t && t.apply(this, Array.prototype.slice.call(arguments, 1)), this
                ...
                if (this.activeElements = t, this.draw(), this.options.customTooltips && this.options.customTooltips(!1), t.length > 0) if (this.datasets && this.datasets.length > 1) {
                    ...
                    var c = [], u = [], d = function (t) {
                        ...
                        return s.each(this.datasets, function (t) {
                            t.showTooltips !== !1 && (i = t.points || t.bars || t.segments, i[h] && i[h].hasValue() && l.push(i[h]))
                        }), s.each(l, function (t) {
                    ...
                    new e.Tooltip({
                        ...
                        cornerRadius: this.options.tooltipCornerRadius,
                        text: S(this.options.tooltipTemplate, t),
                        chart: this.chart,
                        custom: this.options.customTooltips
                    }).draw()
                }, this);
        ...
        initialize: function () {
            ...
            this.yLabels = [];
            for (var t = x(this.stepValue), i = 0; i <= this.steps; i++) this.yLabels.push(S(this.templateString, {value: (this.min + i * this.stepValue).toFixed(t)}));
            ...
            if (this.display) {
                ...
                var o = this.showBeyondLine ? 5 : 0;
                n(this.yLabels, function (n, a) {
                    var h = this.endPoint - i * a, l = Math.round(h), r = this.showHorizontalLines;
                    t.textAlign = "right", t.textBaseline = "middle", this.showLabels && t.fillText(n, e - 10, h), 0 !== a || r || (r = !0), r && t.beginPath(), a > 0 ? (t.lineWidth = this.gridLineWidth, t.strokeStyle = this.gridLineColor) : (t.lineWidth = this.lineWidth, t.strokeStyle = this.lineColor), l += s.aliasPixel(t.lineWidth), r && (t.moveTo(e, l), t.lineTo(this.width, l), t.stroke(), t.closePath()), t.lineWidth = this.lineWidth, t.strokeStyle = this.lineColor, t.beginPath(), t.moveTo(e - o, l), t.lineTo(e, l), t.stroke(), t.closePath()
                }, this), n(this.xLabels, function (i, e) {
                    var s = this.calculateX(e) + y(this.lineWidth),
                        n = this.calculateX(e - (this.offsetGridLines ? .5 : 0)) + y(this.lineWidth),
                        a = this.xLabelRotation > 0, h = this.showVerticalLines;
        ...
        initialize: function () {
            ...
            var t, i, e, s, n, o, a, h, l, r, c, u,
                d = v([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]), f = this.width, g = 0;
            for (this.ctx.font = A(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), i = 0; i < this.valuesCount; i++) t = this.getPointPosition(i, d), e = this.ctx.measureText(S(this.templateString, {value: this.labels[i]})).width + 5, 0 === i || i === this.valuesCount / 2 ? (s = e / 2, t.x + s > f && (f = t.x + s, n = i), t.x - s < g && (g = t.x - s, a = i)) : i < this.valuesCount / 2 ? t.x + e > f && (f = t.x + e, n = i) : i > this.valuesCount / 2 && t.x - e < g && (g = t.x - e, a = i);
            l = g, r = Math.ceil(f - this.width), o = this.getIndexAngle(n), h = this.getIndexAngle(a), c = r / Math.sin(o + Math.PI / 2), u = l / Math.sin(h + Math.PI / 2), c = p(c) ? c : 0, u = p(u) ? u : 0, this.drawingArea = d - (u + c) / 2, this.setCenterPoint(u, c)
        ...
        return e
    }) : "object" == typeof module && module.exports && (module.exports = e), i.Chart = e, t.fn.chart = function () {
        var t = [];
        return this.each(function () {
            t.push(new e(this.getContext("2d")))
        }), 1 === t.length ? t[0] : t
    }
}).call(this, jQuery), function (t) {
    "use strict";
    var i = t && t.zui ? t.zui : this, e = i.Chart, s = e.helpers, n = {
    ...
    e.Type.extend({
        name: "Line", defaults: n, initialize: function (i) {
            ...
            }), this.datasets = [], this.options.showTooltips && s.bindEvents(this, this.options.tooltipEvents, function (t) {
            ...
            }), s.each(i.datasets, function (e) {
                if (t.zui && t.zui.Color && t.zui.Color.get) {
                    var n = t.zui.Color.get(e.color), o = n.toCssStr();
                    e.fillColor || (e.fillColor = n.clone().fade(20).toCssStr()), e.strokeColor || (e.strokeColor = o), e.pointColor || (e.pointColor = o), e.pointStrokeColor || (e.pointStrokeColor = "#fff"), e.pointHighlightFill || (e.pointHighlightFill = "#fff"), e.pointHighlightStroke || (e.pointHighlightStroke = o)
                }
                var a = {
                    label: e.label || null,
                    ...
                    showTooltips: e.showTooltips !== !1,
                    points: []
                };
                this.datasets.push(a), s.each(e.data, function (t, s) {
                    ...
                    s.extend(t, {x: this.scale.calculateX(i), y: this.scale.endPoint}), t.save()
                }, this)
            }, this), this.render()
        }, update: function () {
            this.scale.update(), s.each(this.activeElements, function (t) {
                t.restore(["fillColor", "strokeColor"])
            }), this.eachPoints(function (t) {
                t.save()
            }), this.render()
            ...
            s.each(this.datasets, function (i) {
                s.each(i.points, t, this)
            }, this)
        }, getPointsAtEvent: function (t) {
            var i = [], e = s.getRelativePosition(t);
            return s.each(this.datasets, function (t) {
                s.each(t.points, function (t) {
            ...
            var i = this, n = function () {
                var t = [];
                return i.eachPoints(function (i) {
                    t.push(i.value)
                }), t
            }, o = {
                ...
                calculateYRange: function (t) {
                    var i = s.calculateScaleRange(n(), t, this.fontSize, this.beginAtZero, this.integersOnly);
                    s.extend(this, i)
                },
                xLabels: t,
                font: s.fontString(this.options.scaleFontSize, this.options.scaleFontStyle, this.options.scaleFontFamily),
            ...
            this.options.scaleOverride && s.extend(o, {
                calculateYRange: s.noop,
            ...
            this.scale.removeXLabel(), s.each(this.datasets, function (t) {
                t.points.shift()
            }, this), this.update()
        }, reflow: function () {
            var t = s.extend({height: this.chart.height, width: this.chart.width});
            this.scale.update(t)
        }, draw: function (t) {
            var i = t || 1;
            this.clear();
            var e = this.chart.ctx, n = function (t) {
                return null !== t.value
            }, o = function (t, i, e) {
                return s.findNextWhere(i, n, e) || t
            }, a = function (t, i, e) {
                return s.findPreviousWhere(i, n, e) || t
            };
            this.scale.draw(i), s.each(this.datasets, function (t) {
                var h = s.where(t.points, n);
                s.each(t.points, function (t, e) {
                    t.hasValue() && t.transition({y: this.scale.calculateY(t.value), x: this.scale.calculateX(e)}, i)
                }, this), this.options.bezierCurve && s.each(h, function (t, i) {
                    var e = i > 0 && i < h.length - 1 ? this.options.bezierCurveTension : 0;
                    t.controlPoints = s.splineCurve(a(t, h, i), t, o(t, h, i), e), t.controlPoints.outer.y > this.scale.endPoint ? t.controlPoints.outer.y = this.scale.endPoint : t.controlPoints.outer.y < this.scale.startPoint && (t.controlPoints.outer.y = this.scale.startPoint), t.controlPoints.inner.y > this.scale.endPoint ? t.controlPoints.inner.y = this.scale.endPoint : t.controlPoints.inner.y < this.scale.startPoint && (t.controlPoints.inner.y = this.scale.startPoint)
                }, this), e.lineWidth = this.options.datasetStrokeWidth, e.strokeStyle = t.strokeColor, e.beginPath(), s.each(h, function (t, i) {
                    if (0 === i) e.moveTo(t.x, t.y); else if (this.options.bezierCurve) {
                        var s = a(t, h, i);
                        e.bezierCurveTo(s.controlPoints.outer.x, s.controlPoints.outer.y, t.controlPoints.inner.x, t.controlPoints.inner.y, t.x, t.y)
                    } else e.lineTo(t.x, t.y)
                }, this), e.stroke(), this.options.datasetFill && h.length > 0 && (e.lineTo(h[h.length - 1].x, this.scale.endPoint), e.lineTo(h[0].x, this.scale.endPoint), e.fillStyle = t.fillColor, e.closePath(), e.fill()), s.each(h, function (t) {
                    t.draw()
                })
            }, this)
        }
    }), t.fn.lineChart = function (i, s) {
        var n = [];
        return this.each(function () {
            var o = t(this);
            n.push(new e(this.getContext("2d")).Line(i, t.extend(o.data(), s)))
        }), 1 === n.length ? n[0] : n
    }
}.call(this, jQuery), function (t) {
    "use strict";
    ...
    e.Type.extend({
        name: "Doughnut", defaults: n, initialize: function (t) {
            this.segments = [], this.outerRadius = (s.min([this.chart.width, this.chart.height]) - this.options.segmentStrokeWidth / 2) / 2, this.SegmentArc = e.Arc.extend({
                ctx: this.chart.ctx,
                x: this.chart.width / 2,
                y: this.chart.height / 2
            }), this.options.showTooltips && s.bindEvents(this, this.options.tooltipEvents, function (t) {
            ...
            }), this.calculateTotal(t), s.each(t, function (t, i) {
                this.addData(t, i, !0)
            }, this), this.render()
        }, getSegmentsAtEvent: function (t) {
            var i = [], e = s.getRelativePosition(t);
            return s.each(this.segments, function (t) {
                t.inRange(e.x, e.y) && i.push(t)
            }, this), i
        }, addData: function (i, e, s) {
            if (t.zui && t.zui.Color && t.zui.Color.get) {
                var n = new t.zui.Color.get(i.color);
                i.color = n.toCssStr(), i.highlight || (i.highlight = n.lighten(5).toCssStr())
            }
            var o = e || this.segments.length;
            this.segments.splice(o, 0, new this.SegmentArc({
                id: "undefined" == typeof i.id ? o : i.id,
                value: i.value,
                outerRadius: this.options.animateScale ? 0 : this.outerRadius,
                innerRadius: this.options.animateScale ? 0 : this.outerRadius / 100 * this.options.percentageInnerCutout,
                fillColor: i.color,
                highlightColor: i.highlight || i.color,
                showStroke: this.options.segmentShowStroke,
                strokeWidth: this.options.segmentStrokeWidth,
                strokeColor: this.options.segmentStrokeColor,
                startAngle: 1.5 * Math.PI,
                circumference: this.options.animateRotate ? 0 : this.calculateCircumference(i.value),
                showLabel: i.showLabel !== !1,
                label: i.label
            })), s || (this.reflow(), this.update())
        }, calculateCircumference: function (t) {
            return 2 * Math.PI * (Math.abs(t) / this.total)
        }, calculateTotal: function (t) {
            this.total = 0, s.each(t, function (t) {
                this.total += Math.abs(t.value)
            }, this)
        }, update: function () {
            this.calculateTotal(this.segments), s.each(this.activeElements, function (t) {
                t.restore(["fillColor"])
            }), s.each(this.segments, function (t) {
                t.save()
            }), this.render()
        }, removeData: function (t) {
            var i = s.isNumber(t) ? t : this.segments.length - 1;
            this.segments.splice(i, 1), this.reflow(), this.update()
        }, reflow: function () {
            s.extend(this.SegmentArc.prototype, {
                x: this.chart.width / 2,
                y: this.chart.height / 2
            }), this.outerRadius = (s.min([this.chart.width, this.chart.height]) - this.options.segmentStrokeWidth / 2) / 2, s.each(this.segments, function (t) {
                t.update({
                    outerRadius: this.outerRadius,
                    innerRadius: this.outerRadius / 100 * this.options.percentageInnerCutout
                })
            }, this)
        }, drawLabel: function (i, e, n) {
            var o = this.options, a = (i.endAngle + i.startAngle) / 2, h = o.scaleLabelPlacement;
            "inside" !== h && "outside" !== h && this.chart.width - this.chart.height > 50 && i.circumference < Math.PI / 18 && (h = "outside");
            var l = Math.cos(a) * i.outerRadius, r = Math.sin(a) * i.outerRadius, c = s.template(o.scaleLabel, {
                value: "undefined" == typeof e ? i.value : Math.round(e * i.value),
                label: i.label
            }), u = this.chart.ctx;
            u.font = s.fontString(o.scaleFontSize, o.scaleFontStyle, o.scaleFontFamily), u.textBaseline = "middle", u.textAlign = "center";
            var d = (u.measureText(c).width, this.chart.width / 2), f = this.chart.height / 2;
            if ("outside" === h) {
                var p = l >= 0, g = l + d, v = r + f;
                u.textAlign = p ? "left" : "right", u.measureText(c).width, l = p ? Math.max(d + i.outerRadius + 10, l + 30 + d) : Math.min(d - i.outerRadius - 10, l - 30 + d);
                var x = o.scaleFontSize, m = Math.round((.8 * r + f) / x) + 1,
                    y = (Math.floor(this.chart.width / x) + 1, p ? 1 : -1);
                if (n[m * y] && (m > 1 ? m-- : m++), n[m * y]) return;
                r = (m - 1) * x + o.scaleFontSize / 2, n[m * y] = !0, u.beginPath(), u.moveTo(g, v), u.lineTo(l, r), l = p ? l + 5 : l - 5, u.lineTo(l, r), u.strokeStyle = t.zui && t.zui.Color ? new t.zui.Color(i.fillColor).fade(40).toCssStr() : i.fillColor, u.strokeWidth = o.scaleLineWidth, u.stroke(), u.fillStyle = i.fillColor
            } else l = .7 * l + d, r = .7 * r + f, u.fillStyle = t.zui && t.zui.Color ? new t.zui.Color(i.fillColor).contrast().toCssStr() : "#fff";
            u.fillText(c, l, r)
        }, draw: function (t) {
            var i = t ? t : 1;
            this.clear();
            var e;
            if (s.each(this.segments, function (t, e) {
                    t.transition({
                ...
                var n = this.segments.slice().sort(function (t, i) {
                    return i.value - t.value
                }), e = {};
                s.each(n, function (i, s) {
                    i.showLabel && this.drawLabel(i, t, e)
                }, this)
            }
        }
    }), e.types.Doughnut.extend({
        name: "Pie",
        defaults: s.merge(n, {percentageInnerCutout: 0})
    }), t.fn.pieChart = function (i, s) {
        var n = [];
        return this.each(function () {
            var o = t(this);
            n.push(new e(this.getContext("2d")).Pie(i, t.extend(o.data(), s)))
        }), 1 === n.length ? n[0] : n
    }, t.fn.doughnutChart = function (i, s) {
        var n = [];
        return this.each(function () {
            var o = t(this);
            n.push(new e(this.getContext("2d")).Doughnut(i, t.extend(o.data(), s)))
        }), 1 === n.length ? n[0] : n
    }
}.call(this, jQuery), function (t) {
    "use strict";
    ...
    e.Type.extend({
        name: "Bar", defaults: n, initialize: function (i) {
            var n = this.options;
            this.ScaleClass = e.Scale.extend({
                offsetGridLines: !0, calculateBarX: function (t, i, e) {
                    var s = this.calculateBaseWidth(), o = this.calculateX(e) - s / 2, a = this.calculateBarWidth(t);
                    return o + a * i + i * n.barDatasetSpacing + a / 2
                }, calculateBaseWidth: function () {
                    return this.calculateX(1) - this.calculateX(0) - 2 * n.barValueSpacing
                }, calculateBarWidth: function (t) {
                    var i = this.calculateBaseWidth() - (t - 1) * n.barDatasetSpacing;
                    return i / t
                }
            }), this.datasets = [], this.options.showTooltips && s.bindEvents(this, this.options.tooltipEvents, function (t) {
                ...
                ctx: this.chart.ctx
            }), s.each(i.datasets, function (e, n) {
                if (t.zui && t.zui.Color && t.zui.Color.get) {
                    var o = t.zui.Color.get(e.color), a = o.toCssStr();
                    e.fillColor || (e.fillColor = o.clone().fade(50).toCssStr()), e.strokeColor || (e.strokeColor = a)
                }
                var h = {label: e.label || null, fillColor: e.fillColor, strokeColor: e.strokeColor, bars: []};
                this.datasets.push(h), s.each(e.data, function (t, s) {
            ...
            }, this), this.buildScale(i.labels), this.BarClass.prototype.base = this.scale.endPoint, this.eachBars(function (t, i, e) {
                s.extend(t, {
                    width: this.scale.calculateBarWidth(this.datasets.length),
                    x: this.scale.calculateBarX(this.datasets.length, e, i),
                    y: this.scale.endPoint
                }), t.save()
            }, this), this.render()
        }, update: function () {
            ...
            s.each(this.datasets, function (i, e) {
                s.each(i.bars, t, this, e)
            }, this)
        }, getBarsAtEvent: function (t) {
            for (var i, e = [], n = s.getRelativePosition(t), o = function (t) {
                e.push(t.bars[i])
            }, a = 0; a < this.datasets.length; a++) for (i = 0; i < this.datasets[a].bars.length; i++) if (this.datasets[a].bars[i].inRange(n.x, n.y)) return s.each(this.datasets, o), e;
            return e
        }, buildScale: function (t) {
            var i = this, e = function () {
                ...
                integersOnly: this.options.scaleIntegersOnly,
                calculateYRange: function (t) {
                    var i = s.calculateScaleRange(e(), t, this.fontSize, this.beginAtZero, this.integersOnly);
                    s.extend(this, i)
                },
                xLabels: t,
                font: s.fontString(this.options.scaleFontSize, this.options.scaleFontStyle, this.options.scaleFontFamily),
            ...
            this.options.scaleOverride && s.extend(n, {
                calculateYRange: s.noop,
                steps: this.options.scaleSteps,
                stepValue: this.options.scaleStepWidth,
                min: this.options.scaleStartValue,
            ...
            s.extend(this.BarClass.prototype, {y: this.scale.endPoint, base: this.scale.endPoint});
            var t = s.extend({height: this.chart.height, width: this.chart.width});
            this.scale.update(t)
        }, drawLabel: function (t, i) {
            var e = this.options;
            i = i || e.scaleValuePlacement, i = i ? i.toLowerCase() : "auto", "auto" === i && (i = t.y < 15 ? "insdie" : "outside");
            var n = "insdie" === i ? t.y + 10 : t.y - 10, o = this.chart.ctx;
            o.font = s.fontString(e.scaleFontSize, e.scaleFontStyle, e.scaleFontFamily), o.textBaseline = "middle", o.textAlign = "center", o.fillStyle = e.scaleFontColor, o.fillText(t.value, t.x, n)
        }, draw: function (t) {
            var i = t || 1;
            this.clear();
            this.chart.ctx;
            this.scale.draw(i);
            var e = this.options.scaleShowLabels && this.options.scaleValuePlacement;
            s.each(this.datasets, function (t, n) {
                s.each(t.bars, function (t, s) {
                    t.hasValue() && (t.base = this.scale.endPoint, t.transition({
                        x: this.scale.calculateBarX(this.datasets.length, n, s),
                        y: this.scale.calculateY(t.value),
                        width: this.scale.calculateBarWidth(this.datasets.length)
                    }, i).draw()), e && this.drawLabel(t)
                }, this)
            }, this)
        }
    }), t.fn.barChart = function (i, s) {
        var n = [];
        return this.each(function () {
            var o = t(this);
            n.push(new e(this.getContext("2d")).Bar(i, t.extend(o.data(), s)))
        }), 1 === n.length ? n[0] : n
    }
}.call(this, jQuery);